				...
				<tbody>
					<c:forEach items="${project}" var="p">
						<tr>
							...
							<td><a href="Inprogress_tasks?project_id=${p.getProject_id()}" class="btn btn-primary" style="border-radius:30px;"> <i class="bi bi-people-fill"></i> Inprogress Tasks</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
