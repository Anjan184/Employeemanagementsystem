...
.lgn {
	position: fixed;
	top: 55%; /* Align the top of the form to the middle of the viewport */
	left: 50%;
	/* Align the left of the form to the middle of the viewport */
	transform: translate(-50%, -50%);
	/* Center the form horizontally and vertically */
	width: 350px;
	height: 355px; padding : 10px;
	border: none;
	border-radius: 20px;
	background-color: rgba(255, 255, 255, 0.6);
	z-index: 999;
	padding: 10px; /* Ensure the form is above other elements */
}
...
<body>
	...
	<form action="Dashboard" method="post" class="lgn">
		...
		<span class="login-text d-none d-lg-block">Login Here</span> <label
			for="email" class="mail col-8 text-right font-weight-bold">Username</label>
		...
		<br> <label for="password"
			class="pass col-8 text-right font-weight-bold">Password</label> <br>
		...
		<!-- Add Bootstrap btn and btn-primary classes -->
	</form>
