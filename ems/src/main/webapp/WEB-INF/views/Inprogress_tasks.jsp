			...
			<table class="task-table">
				...
				<tbody>
                    ...
                    ${tsk.status }
							...
							<a href="edit_Inprogress_task?task_id=${tsk.task_id}"><i class="fa-solid fa-pen-nib text-primary"></i></a>
							
							<a href="dete?task_id=${tsk.getTask_id()}"><i class="fa-solid fa-trash text-danger"></i></a>	
