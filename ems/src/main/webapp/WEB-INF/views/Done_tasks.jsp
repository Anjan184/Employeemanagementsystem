			...
			<table class="task-table">
				...
				<tbody>
                    ...
                    ${tsk.status }
							...
							<td><div>
								<a href="edit_done_task?task_id=${tsk.getTask_id()}"><i class="fa-solid fa-pen-nib text-primary"></i></a>
								
									<a href="dlee?task_id=${tsk.getTask_id()}"><i class="fa-solid fa-trash text-danger"></i></a>	
